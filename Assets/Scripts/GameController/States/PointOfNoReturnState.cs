...
public class PointOfNoReturnState : GameState
{
	...
	public override void OnStateEnter()
	{
        ...
        gm.hasGamePlayReachedPointOfNoReturn = true;
	...
	//	gm.fragParticleController = new FragmentParticleController(fragmentPositions, gm.fragmentParticles, gm.Moth.transform);
        ...
        LightSourceInput[] lightsourceInputs = GameObject.FindObjectsOfType<LightSourceInput>();
		foreach (var item in lightsourceInputs)
		{
			item.ForceSwitchOff();
		}
