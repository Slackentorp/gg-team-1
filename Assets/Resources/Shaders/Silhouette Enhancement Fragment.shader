...
Shader "DCC/Silhouette Enhancement Fragment" {
    Properties {
        ...
        _MaintexEmissionMapOverlay ("Maintex Emission Map Overlay", 2D) = "white" {}
        _maintexEmissionOverlayColor ("maintex Emission Overlay Color", Color) = (1,1,1,1)
        _MaintexEmissionOverlayIntensity ("Maintex Emission Overlay Intensity", Range(0, 1)) = 0.5
        _EmissionNoise ("Emission Noise", 2D) = "white" {}
        _EmissionNoiseIntensity ("Emission Noise Intensity", Range(0, 1)) = 0.3
        ...
        _MaintexEmission ("Maintex Emission", 2D) = "white" {}
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform sampler2D _MaintexEmissionMapOverlay; uniform float4 _MaintexEmissionMapOverlay_ST;
            uniform sampler2D _MaintexNormalMap; uniform float4 _MaintexNormalMap_ST;
            uniform float _MaintexEmissionOverlayIntensity;
            uniform float4 _maintexEmissionOverlayColor;
            ...
            uniform sampler2D _MaintexEmission; uniform float4 _MaintexEmission_ST;
...
////// Emissive:
                float4 _MaintexEmission_var = tex2D(_MaintexEmission,TRANSFORM_TEX(i.uv0, _MaintexEmission));
                float3 node_2305 = float3(0,0,0);
                float4 _MaintexEmissionMapOverlay_var = tex2D(_MaintexEmissionMapOverlay,TRANSFORM_TEX(i.uv0, _MaintexEmissionMapOverlay));
                float node_536 = 0.0;
                ...
                float3 node_7434 = lerp(node_2305,lerp(node_2305,lerp((_MaintexEmissionMapOverlay_var.rgb*_maintexEmissionOverlayColor.rgb),float3(node_536,node_536,node_536),(_EmissionNoise_var.rgb*_EmissionNoiseIntensity)),node_1196.rgb),_MaintexEmissionOverlayIntensity);
                float3 emissive = lerp((_MaintexEmissionIntensity*(_MaintexEmission_var.rgb*_MaintexEmissionColor.rgb)),node_7434,node_7434);
/// Final Color:
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float4 node_1196 = tex2D(_DissolveRamp,TRANSFORM_TEX(node_568, _DissolveRamp));
                float3 node_7434 = lerp(node_2305,lerp(node_2305,lerp((_MaintexEmissionMapOverlay_var.rgb*_maintexEmissionOverlayColor.rgb),float3(node_536,node_536,node_536),(_EmissionNoise_var.rgb*_EmissionNoiseIntensity)),node_1196.rgb),_MaintexEmissionOverlayIntensity);
                o.Emission = lerp((_MaintexEmissionIntensity*(_MaintexEmission_var.rgb*_MaintexEmissionColor.rgb)),node_7434,node_7434);
