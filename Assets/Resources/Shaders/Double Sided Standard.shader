...
////// Emissive:
                ...
                float3 node_2851 = lerp((node_7836*_DissolveEmissionIntensity),node_5654,node_5654);
                float3 emissive = lerp((_MaintexEmissionIntensity*(_MaintexEmission_var.rgb*_MaintexEmissionColor.rgb)),node_2851,node_2851);
/// Final Color:
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : SV_Target {
                ...
                float3 node_5654 = lerp(((_Emission_var.rgb*_MaintexEmissions.rgb)*_EmissionIntensity),float3(node_4020,node_4020,node_4020),(_EmissionNoise_var.rgb*_EmissionNoiseIntensity));
                float3 node_2851 = lerp((node_7836*_DissolveEmissionIntensity),node_5654,node_5654);
                o.Emission = lerp((_MaintexEmissionIntensity*(_MaintexEmission_var.rgb*_MaintexEmissionColor.rgb)),node_2851,node_2851);
