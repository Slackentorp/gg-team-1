...
Shader "DCC/Silhouette Enhancement Fragment Transparent" {
    Properties {
        ...
        _MaintexEmissionOverlayIntensity ("Maintex Emission Overlay Intensity", Range(0, 1)) = 0
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float node_3400 = (_MaintexOpacityThreshold*_MainTex_var.a);
                clip(node_3400 - 0.5);
