...
Shader "DCC/Silhouette Enhancement Fragment Transparent" {
    Properties {
        ...
        _TransparencyIntensity ("Transparency Intensity", Range(0, 1)) = 1
        _MaintexEmission ("Maintex Emission", 2D) = "white" {}
        _MaintexEmissionIntensity ("Maintex Emission Intensity", Range(0, 1)) = 0
        _MaintexEmissionColor ("Maintex Emission Color", Color) = (1,1,1,1)
        _MaintexOpacityThreshold ("Maintex Opacity Threshold", Range(0, 1)) = 1
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform float4 _MaintexEmissionColor;
            uniform float _MaintexOpacityThreshold;
            struct VertexInput {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                clip((_MaintexOpacityThreshold*_MainTex_var.a) - 0.5);
...
////// Emissive:
                ...
                float3 node_7434 = lerp(node_2305,lerp(node_2305,lerp((_MaintexEmissionMap_var.rgb*_maintexEmissionColor.rgb),float3(node_536,node_536,node_536),(_EmissionNoise_var.rgb*_EmissionNoiseIntensity)),node_1196.rgb),_MaintexEmissionOverlayIntensity);
...
/// Final Color:
                ...
                fixed4 finalRGBA = fixed4(finalColor,_TransparencyIntensity);
...
/// Final Color:
                ...
                fixed4 finalRGBA = fixed4(finalColor * _TransparencyIntensity,0);
                UNITY_APPLY_FOG(i.fogCoord, finalRGBA);
                return finalRGBA;
            }
            ENDCG
