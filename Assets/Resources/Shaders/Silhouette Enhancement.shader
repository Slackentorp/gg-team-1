...
////// Emissive:
                ...
                float3 emissive = lerp(float3(0,0,0),(_MaintexEmissionMap_var.rgb*_maintexEmissionColor.rgb),_MaintexEmissionIntensity);
/// Final Color:
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float4 _MaintexEmissionMap_var = tex2D(_MaintexEmissionMap,TRANSFORM_TEX(i.uv0, _MaintexEmissionMap));
                o.Emission = lerp(float3(0,0,0),(_MaintexEmissionMap_var.rgb*_maintexEmissionColor.rgb),_MaintexEmissionIntensity);
