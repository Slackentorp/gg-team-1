...
////// Emissive:
                ...
                fixed4 finalRGBA = fixed4(finalColor,(lerp(node_7468,lerp((1.0 - _Fog2MapIntensity),node_1807.r,node_1807.r),node_7468)*_TotalOpacityIntensity));
